...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="Explore community questions and discussions related to mental health, therapy, clinical trials, and more with Trial2Cure.">
    <meta name="keywords" content="Trial2Cure, mental health, therapy, clinical trials, community discussions, patient care, mental health research, healthcare professionals, patient support, mental health awareness, health discussions">
    <meta name="author" content="Trial2Cure">
    <title>Community Q&A | Mental Health and Therapy | Trial2Cure</title>
    <link rel="canonical" href="https://trial2cure.com/mental-health/mental-health-qacommunity" />

    <!-- Open Graph Tags -->
    <meta property="og:title" content="Community Q&A | Mental Health and Therapy | Trial2Cure" />
    <meta property="og:description" content="Explore community questions and discussions related to mental health, therapy, clinical trials, and more with Trial2Cure." />
    <meta property="og:url" content="https://trial2cure.com/mental-health/mental-health-qacommunity" />
    ...
    <meta name="twitter:title" content="Community Q&A | Mental Health and Therapy | Trial2Cure" />
    <meta name="twitter:description" content="Explore community questions and discussions related to mental health, therapy, clinical trials, and more with Trial2Cure." />
    <meta name="twitter:url" content="https://trial2cure.com/mental-health/mental-health-qacommunity" />
    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "WebPage",
            "name": "Community Q&A | Mental Health and Therapy | Trial2Cure",
            "url": "https://trial2cure.com/mental-health-qacommunity",
            "description": "Explore community questions and discussions related to mental health, therapy, clinical trials, and more with Trial2Cure.",
            "publisher": {
                "@type": "Organization",
                "name": "Trial2Cure",
                "logo": {
                ...
                <?php if ($totalItems > 0): ?>
                    <?php foreach ($currentItems as $item): ?>
                        <div class="card border mb-2 lift">
                            <a href="mental-health-qacommunityindex?discussion=<?php echo urlencode($item['discussion']); ?>">
