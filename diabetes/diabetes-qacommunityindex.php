...
<head>
    ...
    <meta name="keywords" content="<?php echo htmlspecialchars(implode(', ', $threadItem['keywords'])); ?>, Trial2Cure, diabetes, blood sugar management, clinical trials, healthcare, patient care, diabetes awareness, blood sugar research, medical research, community discussions, patient support">
    <meta name="author" content="Trial2Cure">
    <title><?php echo htmlspecialchars($threadItem['title']); ?> - Diabetes Q&A | Trial2Cure</title>
    <link rel="canonical" href="https://trial2cure.com/diabetes/diabetes-qacommunityindex?discussion=<?php echo urlencode($threadItem['discussion']); ?>" />

    <!-- Open Graph Tags -->
    <meta property="og:title" content="<?php echo htmlspecialchars($threadItem['title']); ?> - Diabetes Q&A | Trial2Cure" />
    <meta property="og:description" content="<?php echo htmlspecialchars($threadItem['content']); ?>" />
    <meta property="og:url" content="https://trial2cure.com/diabetes/diabetes-qacommunityindex?discussion=<?php echo urlencode($threadItem['discussion']); ?>" />
    ...
    <meta name="twitter:title" content="<?php echo htmlspecialchars($threadItem['title']); ?> - Diabetes Q&A | Trial2Cure" />
    <meta name="twitter:description" content="<?php echo htmlspecialchars($threadItem['content']); ?>" />
    <meta name="twitter:url" content="https://trial2cure.com/diabetes/diabetes-qacommunityindex?discussion=<?php echo urlencode($threadItem['discussion']); ?>" />
    ...
    <script type="application/ld+json">
        {
            ...
            "url": "https://trial2cure.com/diabetes-qacommunityindex?discussion=<?php echo urlencode($threadItem['discussion']); ?>",
            ...
            "mainEntityOfPage": "https://trial2cure.com/diabetes-qacommunityindex?discussion=<?php echo urlencode($threadItem['discussion']); ?>"
        }
    </script>
