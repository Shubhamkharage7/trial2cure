...
// Read JSON file
$jsonString = file_get_contents('./pediatrics_qacommunity_data.json');
if ($jsonString === false) {
...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="Explore community questions and discussions related to pediatrics, child healthcare, autoimmune diseases, clinical trials, and more with Trial2Cure.">
    <meta name="keywords" content="Trial2Cure, pediatrics, child healthcare, clinical trials, community discussions, autoimmune diseases, child health research, pediatric clinical trials, healthcare professionals, patient support, health discussions">
    <meta name="author" content="Trial2Cure">
    <title>Community Q&A | Pediatrics | Trial2Cure</title>
    <link rel="canonical" href="https://trial2cure.com/pediatrics/pediatrics-qacommunity" />

    <!-- Open Graph Tags -->
    <meta property="og:title" content="Community Q&A | Pediatrics | Trial2Cure" />
    <meta property="og:description" content="Explore community questions and discussions related to pediatrics, child healthcare, autoimmune diseases, clinical trials, and more with Trial2Cure." />
    <meta property="og:url" content="https://trial2cure.com/pediatrics/pediatrics-qacommunity" />
    ...
    <meta name="twitter:title" content="Community Q&A | Pediatrics | Trial2Cure" />
    <meta name="twitter:description" content="Explore community questions and discussions related to pediatrics, child healthcare, autoimmune diseases, clinical trials, and more with Trial2Cure." />
    <meta name="twitter:url" content="https://trial2cure.com/pediatrics/pediatrics-qacommunity" />
    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "WebPage",
            "name": "Community Q&A | Pediatrics | Trial2Cure",
            "url": "https://trial2cure.com/pediatrics-qacommunity",
            "description": "Explore community questions and discussions related to pediatrics, child healthcare, autoimmune diseases, clinical trials, and more with Trial2Cure.",
            "publisher": {
                "@type": "Organization",
                "name": "Trial2Cure",
                "logo": {
        ...
        <main class="container col-11 my-lg-10 my-8" id="main">
            ...
            <div class="row justify-content-center">
                <div class="col-10 col-md-7 mb-5 d-flex flex-column flex-md-row justify-content-between">
                    <a href="../pediatrics/" class="btn btn-lg btn-green rounded mb-2 mb-md-0 me-md-2 flex-grow-1 text-center">Check Pediatrics Community</a>
                    <a href="../clinicaltrials?search=pediatrics" class="btn btn-lg btn-green rounded flex-grow-1 text-center">Find Pediatrics Study</a>
                </div>
            </div>
