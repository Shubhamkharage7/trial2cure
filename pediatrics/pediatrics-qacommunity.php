...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="Explore community questions and discussions related to pediatrics, autoimmune diseases, and child healthcare with Trial2Cure.">
    <meta name="keywords" content="Trial2Cure, pediatrics, child healthcare, autoimmune diseases, clinical trials, community, patient care, health discussions">
    ...
    <meta property="og:description" content="Explore community questions and discussions related to pediatrics, autoimmune diseases, and child healthcare with Trial2Cure." />
    ...
    <meta name="twitter:description" content="Explore community questions and discussions related to pediatrics, autoimmune diseases, and child healthcare with Trial2Cure." />
    ...
    <script type="application/ld+json">
        {
            ...
            "url": "https://trial2cure.com/pediatrics/pediatrics-qacommunity",
            "description": "Explore community questions and discussions related to pediatrics, autoimmune diseases, and child healthcare with Trial2Cure.",
            "publisher": {
                "@type": "Organization",
                "name": "Trial2Cure",
                "logo": {
                ...
                <?php if ($totalItems > 0): ?>
                    <?php foreach ($currentItems as $item): ?>
                        <div class="card border mb-2 lift">
                            <a href="pediatrics-qacommunityindex?discussion=<?php echo urlencode($item['discussion']); ?>">
