...
// Read JSON file
$jsonString = file_get_contents('./oncology_hematology_faq_data.json');
if ($jsonString === false) {
...
<head>
    ...
    <meta name="description"
        content="Explore frequently asked questions related to Oncology, Hematology, cancer treatments, clinical trials, blood disorders, and more with Trial2Cure.">
    <meta name="keywords"
        content="Trial2Cure, oncology, hematology, cancer research, clinical trials, FAQs, patient care, medical research, healthcare professionals, cancer treatment, blood disorders, cancer care, oncology FAQs, hematology FAQs">
    <meta name="author" content="Trial2Cure">
    <title>Oncology and Hematology FAQs | Trial2Cure - Clinical Trial Information for Oncology and Hematology Patients</title>
    <link rel="canonical" href="https://trial2cure.com/oncology-hematology/oncology-hematology-faq" />
    ...
    <!-- Open Graph Tags -->
    <meta property="og:title" content="FAQs | Oncology and Hematology | Trial2Cure" />
    <meta property="og:description"
        content="Explore frequently asked questions related to Oncology, Hematology, cancer treatments, clinical trials, blood disorders, and more with Trial2Cure." />
    <meta property="og:url" content="https://trial2cure.com/oncology-hematology/oncology-hematology-faq" />
    ...
    <meta name="twitter:title" content="FAQs | Oncology and Hematology | Trial2Cure" />
    <meta name="twitter:description"
        content="Explore frequently asked questions related to Oncology, Hematology, cancer treatments, clinical trials, blood disorders, and more with Trial2Cure." />
    <meta name="twitter:url" content="https://trial2cure.com/oncology-hematology/oncology-hematology-faq" />
    ...
    <script type="application/ld+json">
        {
            ...
            "mainEntity": [
                <?php foreach ($currentItems as $index => $item): ?> {
                    ...
                    <?php if ($index < count($currentItems) - 1) echo ','; ?>
                <?php endforeach; ?>
            ],
            "author": {
                "@type": "Organization",
            ...
            "url": "https://trial2cure.com/oncology-hematology/oncology-hematology",
            "publisher": {
                "@type": "Organization",
                "name": "Trial2Cure",
                "logo": {
            ...
            <div id="cardContainer">
                <?php foreach ($currentItems as $item): ?>
                    <div class="card border mb-2 lift">
                        <a href="oncology-hematology-faqindex?question=<?php echo urlencode($item['question']); ?>">
