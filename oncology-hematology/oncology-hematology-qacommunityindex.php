...
<head>
    ...
    <meta name="keywords" content="<?php echo htmlspecialchars(implode(', ', $threadItem['keywords'])); ?>, oncology, hematology, cancer research, community discussions, cancer treatment, Trial2Cure, patient support, medical research, blood disorders">
    <meta name="author" content="Trial2Cure">
    <title><?php echo htmlspecialchars($threadItem['title']); ?> - Oncology & Hematology Q&A Community | Trial2Cure</title>
    <link rel="canonical" href="https://trial2cure.com/oncology-hematology/oncology-hematology-qacommunityindex?discussion=<?php echo urlencode($threadItem['discussion']); ?>" />

    <!-- Open Graph Tags -->
    <meta property="og:title" content="<?php echo htmlspecialchars($threadItem['title']); ?> - Oncology & Hematology Q&A Community | Trial2Cure" />
    <meta property="og:description" content="<?php echo htmlspecialchars($threadItem['content']); ?>" />
    <meta property="og:url" content="https://trial2cure.com/oncology-hematology/oncology-hematology-qacommunityindex?discussion=<?php echo urlencode($threadItem['discussion']); ?>" />
    ...
    <meta name="twitter:title" content="<?php echo htmlspecialchars($threadItem['title']); ?> - Oncology & Hematology Q&A Community | Trial2Cure" />
    <meta name="twitter:description" content="<?php echo htmlspecialchars($threadItem['content']); ?>" />
    <meta name="twitter:url" content="https://trial2cure.com/oncology-hematology/oncology-hematology-qacommunityindex?discussion=<?php echo urlencode($threadItem['discussion']); ?>" />
    ...
    <script type="application/ld+json">
        {
            ...
            "url": "https://trial2cure.com/oncology-hematology-qacommunityindex?discussion=<?php echo urlencode($threadItem['discussion']); ?>",
            ...
            "mainEntityOfPage": "https://trial2cure.com/oncology-hematology-qacommunityindex?discussion=<?php echo urlencode($threadItem['discussion']); ?>"
        }
    </script>
