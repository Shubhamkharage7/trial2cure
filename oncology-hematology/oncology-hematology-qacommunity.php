...
// Read JSON file
$jsonString = file_get_contents('./oncology_hematology_qacommunity_data.json');
if ($jsonString === false) {
...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="Explore community questions and discussions related to oncology, hematology, cancer research, and blood disorders with Trial2Cure.">
    <meta name="keywords" content="Trial2Cure, oncology, hematology, cancer research, blood disorders, healthcare, clinical trials, community, cancer treatments, leukemia, lymphoma, patient care, health discussions, oncology research, hematology discussions, cancer clinical trials">
    <meta name="author" content="Trial2Cure">
    <title>Community Q&A | Oncology & Hematology Discussions | Trial2Cure</title>
    <link rel="canonical" href="https://trial2cure.com/oncology-hematology/oncology-hematology-qacommunity" />

    <!-- Open Graph Tags -->
    <meta property="og:title" content="Community Q&A | Oncology & Hematology Discussions | Trial2Cure" />
    <meta property="og:description" content="Explore community questions and discussions related to oncology, hematology, cancer research, and blood disorders with Trial2Cure." />
    <meta property="og:url" content="https://trial2cure.com/oncology-hematology/oncology-hematology-qacommunity" />
    ...
    <meta name="twitter:title" content="Community Q&A | Oncology & Hematology Discussions | Trial2Cure" />
    <meta name="twitter:description" content="Explore community questions and discussions related to oncology, hematology, cancer research, and blood disorders with Trial2Cure." />
    <meta name="twitter:url" content="https://trial2cure.com/oncology-hematology/oncology-hematology-qacommunity" />
    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "WebPage",
            "name": "Community Q&A | Oncology & Hematology Discussions | Trial2Cure",
            "description": "Explore community questions and discussions related to oncology, hematology, cancer research, and blood disorders with Trial2Cure.",
            "url": "https://trial2cure.com/oncology-hematology-qacommunity",
            "publisher": {
                "@type": "Organization",
                "name": "Trial2Cure",
                "logo": {
                ...
                <?php if ($totalItems > 0): ?>
                    <?php foreach ($currentItems as $item): ?>
                        <div class="card border mb-2 lift">
                            <a href="oncology-hematology-qacommunityindex?discussion=<?php echo urlencode($item['discussion']); ?>">
