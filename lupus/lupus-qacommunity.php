...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="Join open discussions on lupus and autoimmune diseases. Explore questions and share insights with the lupus community on Trial2Cure.">
    <meta name="keywords" content="Trial2Cure, lupus, autoimmune disease, healthcare, clinical trials, Q&A community, patient care, medical research, health discussions">
    <meta name="author" content="Trial2Cure">
    <title>Lupus Community Q&A | Discussions & Insights | Trial2Cure</title>
    <link rel="canonical" href="https://trial2cure.com/lupus/lupus-qacommunity" />

    <!-- Open Graph Tags -->
    <meta property="og:title" content="Lupus Community Q&A | Discussions & Insights | Trial2Cure" />
    <meta property="og:description" content="Join open discussions on lupus and autoimmune diseases. Explore questions and share insights with the lupus community on Trial2Cure." />
    <meta property="og:url" content="https://trial2cure.com/lupus/lupus-qacommunity" />
    ...
    <meta name="twitter:title" content="Lupus Community Q&A | Discussions & Insights | Trial2Cure" />
    <meta name="twitter:description" content="Join open discussions on lupus and autoimmune diseases. Explore questions and share insights with the lupus community on Trial2Cure." />
    <meta name="twitter:url" content="https://trial2cure.com/lupus/lupus-qacommunity" />
    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "WebPage",
            "name": "Lupus Community Q&A | Discussions & Insights | Trial2Cure",
            "url": "https://trial2cure.com/lupus-qacommunity",
            "description": "Join open discussions on lupus and autoimmune diseases. Explore questions and share insights with the lupus community on Trial2Cure.",
            "publisher": {
                "@type": "Organization",
                "name": "Trial2Cure",
                "logo": {
                ...
                <?php if ($totalItems > 0): ?>
                    <?php foreach ($currentItems as $item): ?>
                        <div class="card border mb-2 lift">
                            <a href="lupus-qacommunityindex?discussion=<?php echo urlencode($item['discussion']); ?>">
