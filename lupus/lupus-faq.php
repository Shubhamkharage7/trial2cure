...
// Read JSON file
$jsonString = file_get_contents('./lupus_faq_data.json');
if ($jsonString === false) {
...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="Find answers to frequently asked questions about lupus, an autoimmune disease, and learn about ongoing clinical trials at Trial2Cure.">
    <meta name="keywords" content="Trial2Cure, lupus FAQs, autoimmune disease, lupus treatment, clinical trials, healthcare, patient care, medical research, disease management, healthcare professionals, health information">
    <meta name="author" content="Trial2Cure">
    <title>Lupus FAQs | Trial2Cure - Clinical Trial Information for Lupus Patients</title>
    <link rel="canonical" href="https://trial2cure.com/lupus/lupus-faq" />
    ...
    <!-- Open Graph Tags -->
    <meta property="og:title" content="Lupus FAQs | Trial2Cure - Clinical Trial Information for Lupus Patients" />
    <meta property="og:description" content="Find answers to frequently asked questions about lupus, an autoimmune disease, and learn about ongoing clinical trials at Trial2Cure." />
    <meta property="og:url" content="https://trial2cure.com/lupus/lupus" />
    ...
    <meta name="twitter:title" content="Lupus FAQs | Trial2Cure - Clinical Trial Information for Lupus Patients" />
    <meta name="twitter:description" content="Find answers to frequently asked questions about lupus, an autoimmune disease, and learn about ongoing clinical trials at Trial2Cure." />
    <meta name="twitter:url" content="https://trial2cure.com/lupus/lupus" />
    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "WebPage",
            "name": "Lupus FAQs | Trial2Cure",
            "url": "https://trial2cure.com/lupus-faqs",
            "description": "Find answers to frequently asked questions about lupus, an autoimmune disease, and learn about ongoing clinical trials at Trial2Cure.",
            "publisher": {
                "@type": "Organization",
                "name": "Trial2Cure",
                "logo": {
            ...
            <div id="cardContainer">
                <?php foreach ($currentItems as $item): ?>
                    <div class="card border mb-2 lift">
                        <a href="lupus-faqindex?question=<?php echo urlencode($item['question']); ?>">
