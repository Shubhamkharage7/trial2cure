...
$jsonFilePath = './lupus_faq_data.json';
...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="<?php echo htmlspecialchars($faqItem['answer']); ?> Find out more about lupus and related clinical trials.">
    <meta name="keywords" content="Lupus FAQs, lupus clinical trials, autoimmune disease, FAQs, Trial2Cure, medical research, healthcare information, lupus treatment options">
    <meta name="author" content="Trial2Cure">
    <title><?php echo htmlspecialchars($faqItem['q']); ?> - Lupus FAQs | Trial2Cure - Clinical Trial Information</title>
    <link rel="canonical" href="https://trial2cure.com/lupus/lupus-faqindex?question=<?php echo urlencode($faqItem['question']); ?>" />

    <!-- Open Graph Tags -->
    <meta property="og:title" content="<?php echo htmlspecialchars($faqItem['q']); ?> - Lupus FAQs | Trial2Cure" />
    <meta property="og:description" content="<?php echo htmlspecialchars($faqItem['answer']); ?> Learn more about lupus and ongoing clinical trials at Trial2Cure." />
    <meta property="og:url" content="https://trial2cure.com/lupus/lupus-faqindex?question=<?php echo urlencode($faqItem['question']); ?>" />
    ...
    <meta name="twitter:title" content="<?php echo htmlspecialchars($faqItem['q']); ?> - Lupus FAQs | Trial2Cure" />
    <meta name="twitter:description" content="<?php echo htmlspecialchars($faqItem['answer']); ?> Explore information on lupus and related clinical trials at Trial2Cure." />
    <meta name="twitter:url" content="https://trial2cure.com/lupus/lupus-faqindex?question=<?php echo urlencode($faqItem['question']); ?>" />
    ...
    <script type="application/ld+json">
        {
            ...
            "url": "https://trial2cure.com/lupus/lupus-faqindex?question=<?php echo urlencode($faqItem['question']); ?>",
            ...
            "mainEntityOfPage": "https://trial2cure.com/lupus/lupus-faqindex?question=<?php echo urlencode($faqItem['question']); ?>"
        }
    </script>
