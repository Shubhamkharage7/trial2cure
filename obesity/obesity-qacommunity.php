...
// Read JSON file
$jsonString = file_get_contents('./obesity_qacommunity_data.json');
if ($jsonString === false) {
...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="Explore community questions and discussions related to obesity, weight management, clinical trials, and more with Trial2Cure.">
    <meta name="keywords" content="Trial2Cure, obesity, weight management, clinical trials, community discussions, patient care, obesity research, healthcare professionals, patient support, obesity awareness, health discussions">
    <meta name="author" content="Trial2Cure">
    <title>Community Q&A | Obesity and Weight Management | Trial2Cure</title>
    <link rel="canonical" href="https://trial2cure.com/obesity/obesity-qacommunity" />

    <!-- Open Graph Tags -->
    <meta property="og:title" content="Community Q&A | Obesity and Weight Management | Trial2Cure" />
    <meta property="og:description" content="Explore community questions and discussions related to obesity, weight management, clinical trials, and more with Trial2Cure." />
    <meta property="og:url" content="https://trial2cure.com/obesity/obesity-qacommunity" />
    ...
    <meta name="twitter:title" content="Community Q&A | Obesity and Weight Management | Trial2Cure" />
    <meta name="twitter:description" content="Explore community questions and discussions related to obesity, weight management, clinical trials, and more with Trial2Cure." />
    <meta name="twitter:url" content="https://trial2cure.com/obesity/obesity-qacommunity" />
    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "WebPage",
            "name": "Community Q&A | Obesity and Weight Management | Trial2Cure",
            "url": "https://trial2cure.com/obesity-qacommunity",
            "description": "Explore community questions and discussions related to obesity, weight management, clinical trials, and more with Trial2Cure.",
            "publisher": {
                "@type": "Organization",
                "name": "Trial2Cure",
                "logo": {
                ...
                <?php if ($totalItems > 0): ?>
                    <?php foreach ($currentItems as $item): ?>
                        <div class="card border mb-2 lift">
                            <a href="obesity-qacommunityindex?discussion=<?php echo urlencode($item['discussion']); ?>">
